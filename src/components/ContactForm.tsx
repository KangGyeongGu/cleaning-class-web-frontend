...
function CustomDropdown({ label, name, options, placeholder, required, error, value, onChange }: CustomDropdownProps) {
...
export function ContactForm({ phone }: ContactFormProps) {
  ...
  const checkFormValidity = () => {
    ...
    const isValid = name !== '' && phoneValue !== '' && region !== '' && serviceType !== '' && message !== '';
        ...
        >
            ...
            {phone && (
              <p className="mt-3 text-slate-600 text-sm">
                유선상담{' '}
                <a href={`tel:${phone}`} className="font-bold text-slate-900 hover:underline">{phone}</a>
              </p>
            )}
        </motion.div>
        ...
        >
            <div className="space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="group">
                        <label htmlFor="name" className="block text-xs font-bold text-slate-900 tracking-wider mb-3">
                          성함
                    ...
                    <div className="group">
                        <label htmlFor="phone" className="block text-xs font-bold text-slate-900 tracking-wider mb-3">
                          연락처
                          <span className="text-red-500 ml-1">*</span>
                        </label>
                        <input
                ...
                <CustomDropdown
                  label="서비스 종류"
                  name="serviceType"
                  options={['거주청소', '정기청소', '특수청소', '쓰레기집청소', '상가청소', '기타 문의']}
                ...
                <div className="group">
                    <label htmlFor="message" className="block text-xs font-bold text-slate-900 tracking-wider mb-3">
                      문의사항
                      <span className="text-red-500 ml-1">*</span>
                    </label>
                    <textarea
                    ...
                    <div className="flex justify-between mt-1">
                      ...
                      <span className="text-xs text-slate-400">{messageLength}/1000</span>
                    </div>
                            ...
                            {images.length > 0 && (
                              <div className="flex flex-wrap gap-2">
                                {images.map((file, index) => (
                                  ...
                                  <div key={`${file.name}-${file.lastModified}-${index}`} className="relative w-20 h-20 group/image">
