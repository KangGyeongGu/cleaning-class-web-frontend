  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white px-4">
      <div className="w-full max-w-md">
        <h1 className="text-4xl font-black text-slate-900 mb-2 text-center">청소클라쓰</h1>
        <p className="text-center text-slate-500 font-light mb-12">관리자 로그인</p>
        ...
        <form action={formAction} className="space-y-8">
          ...
          <div>
            <label htmlFor="password" className="block text-xs font-bold text-slate-900 uppercase tracking-widest mb-3">
              Password
            </label>
            <input
              id="password"
