...
export function TermsV20260607(): React.ReactElement {
  return (
    <>
      ...
      <div className="space-y-12">
        <section aria-labelledby="terms-article-1">
          <h2 id="terms-article-1" className="text-heading-3 mb-4">
            제1조 (목적)
          </h2>
        ...
        <section aria-labelledby="terms-article-2">
          <h2 id="terms-article-2" className="text-heading-3 mb-4">
            제2조 (정의)
          </h2>
          <ol className="space-y-3 text-sm leading-relaxed font-light text-slate-700">
            ...
            <li>
              3. &ldquo;서비스&rdquo;란 사이트를 통해 제공되는 청소·이사 서비스
              안내, 견적문의, 후기 열람 및 작성 등 일체의 서비스를 말합니다.
            </li>
            <li>
              4. &ldquo;서비스 용역&rdquo;이란 회사가 이용자의 요청에 따라
              제공하는{" "}
              <strong className="font-medium text-slate-900">
                청소 용역(거주·입주·정기·특수·쓰레기집·상가 청소 등)
              </strong>{" "}
              및{" "}
              <strong className="font-medium text-slate-900">
                이사 용역(원룸·일반·반포장·포장·부분 이사 등)
              </strong>
              을 말합니다.
            </li>
          </ol>
        ...
        <section aria-labelledby="terms-article-3">
          <h2 id="terms-article-3" className="text-heading-3 mb-4">
            제3조 (약관의 효력 및 변경)
          </h2>
          <ol className="space-y-4 text-sm leading-relaxed font-light text-slate-700">
            ...
            <li>
              6. 이전 시행 약관은 페이지 상단의 시행 버전 선택을 통해 확인하실
              수 있습니다.{" "}
              <Link
                href="/policy/terms/2026-03-23"
        ...
        <section aria-labelledby="terms-article-4">
          <h2 id="terms-article-4" className="text-heading-3 mb-4">
            제4조 (서비스의 제공)
          </h2>
          <ol className="space-y-4 text-sm leading-relaxed font-light text-slate-700">
            <li>
              ...
              <ul className="mt-2 ml-4 space-y-1">
                <li>가. 청소·이사 서비스 종류 및 내용 안내</li>
                <li>나. 견적문의 접수 및 상담</li>
                <li>다. 고객 후기 및 작업 사례 제공</li>
                <li>라. 이용자의 후기 작성 기능 제공</li>
              </ul>
            </li>
        ...
        <section aria-labelledby="terms-article-5">
          <h2 id="terms-article-5" className="text-heading-3 mb-4">
            제5조 (서비스의 변경 및 중단)
          </h2>
          <ol className="space-y-4 text-sm leading-relaxed font-light text-slate-700">
            <li>
        ...
        <section aria-labelledby="terms-article-6">
          <h2 id="terms-article-6" className="text-heading-3 mb-4">
            제6조 (견적문의)
          </h2>
          <ol className="space-y-3 text-sm leading-relaxed font-light text-slate-700">
            <li>
              1. 이용자는 사이트의 견적문의 양식을 통해 청소·이사 서비스를
              문의할 수 있습니다.
            </li>
            <li>
        ...
        <section aria-labelledby="terms-article-7">
          <h2 id="terms-article-7" className="text-heading-3 mb-4">
            제7조 (이용자의 의무)
          </h2>
        ...
        <section aria-labelledby="terms-article-7-2">
          <h2 id="terms-article-7-2" className="text-heading-3 mb-4">
            제7조의2 (이용자 게시물)
          </h2>
          <ol className="space-y-4 text-sm leading-relaxed font-light text-slate-700">
            <li>
              1. 이용자는 사이트의 후기 작성 기능을 통해 닉네임, 별점, 후기 내용
              및 서비스 종류를 직접 입력하여 게시할 수 있습니다.
            </li>
            <li>
              <p>
                2. 회사는 다음 각 호의 어느 하나에 해당하는 게시물을 사전 통지
                없이 비공개 또는 삭제할 수 있습니다.
              </p>
              <ul className="mt-2 ml-4 space-y-1">
                <li>가. 허위 또는 과장된 정보가 포함된 게시물</li>
                <li>
                  나. 타인의 명예를 훼손하거나 모욕·욕설·차별적 표현이 포함된
                  게시물
                </li>
                <li>다. 광고·홍보·스팸 등 영리 목적의 게시물</li>
                <li>라. 저작권·초상권 등 타인의 권리를 침해하는 게시물</li>
                <li>마. 관련 법령 또는 공공질서·미풍양속에 위배되는 게시물</li>
              </ul>
            </li>
            <li>
              3. 이용자는 본인이 작성한 게시물에 대하여 회사에 비공개 또는
              삭제를 요청할 수 있으며, 회사는 본인 여부 확인 후 합리적인 기간
              내에 처리합니다.
            </li>
            <li>
              4. 이용자가 작성한 게시물은 회사의 서비스 운영 및 홍보 목적으로
              이용될 수 있으며, 이용자는 이러한 목적의 이용에 동의한 것으로
              봅니다.
            </li>
          </ol>
        </section>
        ...
        <section aria-labelledby="terms-article-8">
          <h2 id="terms-article-8" className="text-heading-3 mb-4">
            제8조 (회사의 의무)
          </h2>
          <ol className="space-y-3 text-sm leading-relaxed font-light text-slate-700">
            <li>
        ...
        <section aria-labelledby="terms-article-9">
          <h2 id="terms-article-9" className="text-heading-3 mb-4">
            제9조 (저작권 및 지적재산권)
          </h2>
          <ol className="space-y-3 text-sm leading-relaxed font-light text-slate-700">
            <li>
        ...
        <section aria-labelledby="terms-article-10">
          <h2 id="terms-article-10" className="text-heading-3 mb-4">
            제10조 (면책사항)
          </h2>
          <ol className="space-y-3 text-sm leading-relaxed font-light text-slate-700">
            <li>
        ...
        <section aria-labelledby="terms-article-11">
          <h2 id="terms-article-11" className="text-heading-3 mb-4">
            제11조 (분쟁해결 및 관할법원)
          </h2>
          <ol className="space-y-3 text-sm leading-relaxed font-light text-slate-700">
            <li>
        ...
        <section aria-labelledby="terms-addendum">
          <h2 id="terms-addendum" className="text-heading-3 mb-4">
            부칙
          </h2>
          <p className="text-sm leading-relaxed font-light text-slate-700">
            <strong className="font-medium text-slate-900">
              이 약관은 2026년 6월 7일부터 시행합니다.
            </strong>
          </p>
        </section>
      </div>
