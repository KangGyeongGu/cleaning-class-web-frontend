export function TermsV20260323(): React.ReactElement {
  return (
    <>
      ...
      <div className="space-y-12">
        <section aria-labelledby="terms-v1-article-1">
          <h2 id="terms-v1-article-1" className="text-heading-3 mb-4">
            제1조 (목적)
          </h2>
        ...
        <section aria-labelledby="terms-v1-article-2">
          <h2 id="terms-v1-article-2" className="text-heading-3 mb-4">
            제2조 (정의)
          </h2>
        ...
        <section aria-labelledby="terms-v1-article-3">
          <h2 id="terms-v1-article-3" className="text-heading-3 mb-4">
            제3조 (약관의 효력 및 변경)
          </h2>
        ...
        <section aria-labelledby="terms-v1-article-4">
          <h2 id="terms-v1-article-4" className="text-heading-3 mb-4">
            제4조 (서비스의 제공)
          </h2>
          <ol className="space-y-4 text-sm leading-relaxed font-light text-slate-700">
            <li>
        ...
        <section aria-labelledby="terms-v1-article-5">
          <h2 id="terms-v1-article-5" className="text-heading-3 mb-4">
            제5조 (서비스의 변경 및 중단)
          </h2>
          <ol className="space-y-4 text-sm leading-relaxed font-light text-slate-700">
            <li>
        ...
        <section aria-labelledby="terms-v1-article-6">
          <h2 id="terms-v1-article-6" className="text-heading-3 mb-4">
            제6조 (견적문의)
          </h2>
          <ol className="space-y-3 text-sm leading-relaxed font-light text-slate-700">
            <li>
        ...
        <section aria-labelledby="terms-v1-article-7">
          <h2 id="terms-v1-article-7" className="text-heading-3 mb-4">
            제7조 (이용자의 의무)
          </h2>
        ...
        <section aria-labelledby="terms-v1-article-8">
          <h2 id="terms-v1-article-8" className="text-heading-3 mb-4">
            제8조 (회사의 의무)
          </h2>
          <ol className="space-y-3 text-sm leading-relaxed font-light text-slate-700">
            <li>
        ...
        <section aria-labelledby="terms-v1-article-9">
          <h2 id="terms-v1-article-9" className="text-heading-3 mb-4">
            제9조 (저작권 및 지적재산권)
          </h2>
          <ol className="space-y-3 text-sm leading-relaxed font-light text-slate-700">
            <li>
        ...
        <section aria-labelledby="terms-v1-article-10">
          <h2 id="terms-v1-article-10" className="text-heading-3 mb-4">
            제10조 (면책사항)
          </h2>
          <ol className="space-y-3 text-sm leading-relaxed font-light text-slate-700">
            <li>
        ...
        <section aria-labelledby="terms-v1-article-11">
          <h2 id="terms-v1-article-11" className="text-heading-3 mb-4">
            제11조 (분쟁해결 및 관할법원)
          </h2>
          <ol className="space-y-3 text-sm leading-relaxed font-light text-slate-700">
            <li>
        ...
        <section aria-labelledby="terms-v1-addendum">
          <h2 id="terms-v1-addendum" className="text-heading-3 mb-4">
            부칙
          </h2>
          <p className="text-sm leading-relaxed font-light text-slate-700">
            <strong className="font-medium text-slate-900">
