...
Use `preload` for above-the-fold images (LCP). The `priority` prop is deprecated in Next.js 16+.

```tsx
// Hero image - loads immediately (Next.js 16+: use preload, not priority)
...
// Do NOT combine preload with loading or fetchPriority props
```
